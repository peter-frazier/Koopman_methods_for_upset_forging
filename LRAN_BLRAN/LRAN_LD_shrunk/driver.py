...
# -- Model ---------------------------------------------------------------------
model   = LRAN_LD(n_x, n_u, args.n_z, args.n_h, args.activation, args.alpha, args.init_scale)
n_param = sum(p.numel() for p in model.parameters())
logger.debug(f'LRAN-LD | n_x={n_x}  n_u={n_u}  n_h={args.n_h}  n_z={args.n_z}  alpha={args.alpha}  '
             f'(width={16*args.alpha})  activation={args.activation} | params={n_param:,}')
