...
"""
BLRAN hyperparameter sweep -- job script generator for OSC (SLURM).
...
parser = argparse.ArgumentParser(description='BLRAN model grid')
...
def result_dir(p, seed):
    return f'metrics_blran_{_tag(p, seed)}'
